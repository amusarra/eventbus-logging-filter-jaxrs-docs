...
== Aggiornamento v1.4.0 — Nuove proprietà di configurazione del dispatcher
...
[source,properties, title="*Configurazione 2b* - Nuove proprietà per il TraceEventDispatcher (v1.4.0)"]
....
